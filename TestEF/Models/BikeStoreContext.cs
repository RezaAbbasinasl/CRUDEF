...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=.\\SQL2022;Initial Catalog=BikeStore;Integrated Security=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Brand>(entity =>
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E2729854EC5");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B4C69B189D");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85F6069999");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__4659622925D18568");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D47EF17AA2");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF527EA3892");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C1743D0FB");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E61643815D11C").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D3622B2FAD");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C5441CF1E");
